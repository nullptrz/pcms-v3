...
import assignment.pcms.util.FileService;
...
public class UserLoginController {
    ...
    void login(ActionEvent event) {
        ...
        FileService checkFile = new FileService();
        try {
            checkFile.checkFileExist(itemFile);
            checkFile.checkFileExist(catFile);
            checkFile.checkFileExist(suppFile);
        } catch (IOException e) {
            e.printStackTrace();
        }
